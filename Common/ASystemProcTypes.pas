...
type
  ...
  ASystem_GetDirectoryPath_Proc = function(out Value: AString_Type): AInt; stdcall;
  ...
  ASystem_GetProgramName_Proc = function(out Value: AString_Type): AInt; stdcall;
  ASystem_GetProgramVersionStr_Proc = function(out Value: AString_Type): AError; stdcall;
  ASystem_GetResourceString_Proc = function(const Section, Name, Default: AString_Type; out Value: AString_Type): AInt; stdcall;
  ...
  ASystem_ParamStr_Proc = function(Index: AInt; out Value: AString_Type): AInt; stdcall;
